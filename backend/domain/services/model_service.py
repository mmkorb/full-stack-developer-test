...
class Model:
    def __init__(self, model_name: str):
        ...
        self.model = ort.InferenceSession(f"infrastructure/ai_models/{model_name}.onnx", providers=providers)
...
class ModelSingleton:
    ...
    @staticmethod
    def get_instance(ai_model="yolov8s"):
        if ModelSingleton._instance is None:
            ModelSingleton._instance = Model(ai_model)
